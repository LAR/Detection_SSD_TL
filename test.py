...
parser.add_argument('--trained_model', default='weights/ADNet/ssd300_Tomato_5000.pth',
...
def test_net(save_folder, net, cuda, testset, transform, thresh):
    ...
    for i in range(num_images):
        ...
        imageFile='./data/VOC2007/JPEGImages/'+img_id+'.jpg'
...
#
                ...
                j += 1
#         plt.show()
        plt.savefig('./eval/ADNet/'+img_id+'box.jpg',format='jpg')
        plt.close()
