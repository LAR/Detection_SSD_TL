...
from CornerNet.utils import stdout_to_tqdm
from CornerNet.config import system_configs
from CornerNet.nnet.py_factory import NetworkFactory
from torch.multiprocessing import Process, Queue, Pool
from CornerNet.db.datasets import datasets
...
def train(training_dbs, validation_db, start_iter=0):
    ...
    with stdout_to_tqdm() as save_stdout:
        ...
        nnet.save_params(max_iteration)
...
if __name__ == "__main__":
    ...
    cfg_file_json = os.path.join(system_configs.config_dir, cfg_file + ".json")
    with open(cfg_file_json, "r") as f:
        configs = json.load(f)
    ...
    train(training_dbs, validation_db, start_iter)
